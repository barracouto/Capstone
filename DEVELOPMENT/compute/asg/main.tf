module "asg" {
  ...
  instance_profile_name = module.dev_ec2_iam.instance_profile_name
  ...
  http_target_group_arn  = data.terraform_remote_state.dev_alb.outputs.http_target_group_arn
  https_target_group_arn = data.terraform_remote_state.dev_alb.outputs.https_target_group_arn
}
